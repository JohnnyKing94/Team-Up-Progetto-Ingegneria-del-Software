...
Sala riunioni imbottita? Cucina troppo buia? Il condizionatore d\'aria non sta facendo il suo lavoro? Monitora, rivedi e migliora il tuo ambiente.';
        ...
        $users = [
            [ 'email' => 'system@email.com', 'password' => Hash::make('password'), 'name' => 'System', 'surname' => '', 'birthday' => '1994-11-16', 'gender' => 'Non specificato', 'skills' => '', 'interests' => '', 'isAdmin' => 1, 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s'), ],
        ...
        $projects = [
            [ 'name' => 'Project 1', 'description' => Lipsum::short()->text(3), 'labels' => 'Svago,Tecnologia,Economia', 'leader_id' => '2', 'slug' => 'project-1-' . Project::createSlugCode(), 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s'), ],
            [ 'name' => 'Project 2', 'description' => Lipsum::short()->text(2), 'labels' => 'Economia,Politica', 'leader_id' => '2', 'slug' => 'project-2-' . Project::createSlugCode(), 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s'), ],
            [ 'name' => 'Project 3', 'description' => Lipsum::short()->text(4), 'labels' => 'Medicina,Volontariato,Viaggio', 'leader_id' => '3', 'slug' => 'project-3-' . Project::createSlugCode(), 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s'), ],
            [ 'name' => 'Project 4', 'description' => Lipsum::short()->text(4), 'labels' => 'Svago,Viaggio,Musica', 'leader_id' => '3', 'slug' => 'project-4-' . Project::createSlugCode(), 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s'), ],
            [ 'name' => 'Project 5', 'description' => Lipsum::short()->text(1), 'labels' => 'Svago,Arte & Disegno,Lettura', 'leader_id' => '4', 'slug' => 'project-5-' . Project::createSlugCode(), 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s'), ],
            [ 'name' => 'Project 6', 'description' => Lipsum::short()->text(3), 'labels' => 'Sport,Videogioco', 'leader_id' => '4', 'slug' => 'project-6-' . Project::createSlugCode(), 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s'), ],
            [ 'name' => 'Project 7', 'description' => Lipsum::short()->text(3), 'labels' => 'Economia,Politica,Lettura', 'leader_id' => '5', 'slug' => 'project-7-' . Project::createSlugCode(), 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s'), ],
            [ 'name' => 'Project 8', 'description' => Lipsum::short()->text(3), 'labels' => 'Sport,Medicina', 'leader_id' => '5', 'slug' => 'project-8-' . Project::createSlugCode(), 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s'), ],
            [ 'name' => 'Indoor Environment Monitor', 'description' => $description1, 'labels' => 'Tecnologia', 'leader_id' => '3', 'slug' => 'indoor-environment-monitor-' . Project::createSlugCode(), 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s'), ],
            [ 'name' => 'MMR Calculation System', 'description' => $description2, 'labels' => 'Svago,Tecnologia,Videogioco', 'leader_id' => '4', 'slug' => 'mmr-calculation-system-' . Project::createSlugCode(), 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s'), ],
            [ 'name' => '8D Tunes', 'description' => $description3, 'labels' => 'Svago,Tecnologia,Musica', 'leader_id' => '5', 'slug' => '8d-tunes-' . Project::createSlugCode(), 'created_at' => Carbon::now()->format('Y-m-d H:i:s'), 'updated_at' => Carbon::now()->format('Y-m-d H:i:s'), ],
        ];
        ...
        $teammates = [
            ...
            [ 'teammate_id' => '5', 'project_id' => '1', 'identifier' => ParticipationRequest::createIdentifier(), 'date' => Carbon::now()->format('Y-m-d H:i:s'), ],
            [ 'teammate_id' => '2', 'project_id' => '3', 'identifier' => ParticipationRequest::createIdentifier(), 'date' => Carbon::now()->format('Y-m-d H:i:s'), ],
            [ 'teammate_id' => '4', 'project_id' => '3', 'identifier' => ParticipationRequest::createIdentifier(), 'date' => Carbon::now()->format('Y-m-d H:i:s'), ],
            [ 'teammate_id' => '5', 'project_id' => '3', 'identifier' => ParticipationRequest::createIdentifier(), 'date' => Carbon::now()->format('Y-m-d H:i:s'), ],
            [ 'teammate_id' => '2', 'project_id' => '5', 'identifier' => ParticipationRequest::createIdentifier(), 'date' => Carbon::now()->format('Y-m-d H:i:s'), ],
            [ 'teammate_id' => '3', 'project_id' => '5', 'identifier' => ParticipationRequest::createIdentifier(), 'date' => Carbon::now()->format('Y-m-d H:i:s'), ],
            [ 'teammate_id' => '5', 'project_id' => '5', 'identifier' => ParticipationRequest::createIdentifier(), 'date' => Carbon::now()->format('Y-m-d H:i:s'), ],
            ...
            [ 'teammate_id' => '4', 'project_id' => '7', 'identifier' => ParticipationRequest::createIdentifier(), 'date' => Carbon::now()->format('Y-m-d H:i:s'), ],
        ];
